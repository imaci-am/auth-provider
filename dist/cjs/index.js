...
var AuthStateContext = React.createContext(initialState);
var AuthDispatchContext = React.createContext(undefined);
...
var AuthProvider = function (_a) {
    ...
    var _b = React.useReducer(authReducer, initialState), state = _b[0], dispatch = _b[1];
    var isAuthenticated = state.isAuthenticated, user = state.user;
    var loadUser = React.useCallback(function () {
        return config
            .loadUser()
            .then(function (user) {
            dispatch({
    ...
    var forceLogoutHandler = React.useCallback(function () {
        var _a;
        dispatch({
            type: ActionsEnum.LOGOUT,
        });
    ...
    var dispatchContext = React.useMemo(function () { return ({ dispatch: dispatch, config: config, refetchUser: loadUser }); }, [config, loadUser]);
...
function useAuthDispatch() {
    ...
    var login = React.useCallback(function (loginProps) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loginWithSession = React.useCallback(function (accessToken, refreshToken, expirationDate) {
        saveInStorage({
            accessToken: accessToken,
            refreshToken: refreshToken,
            expirationDate: expirationDate !== null && expirationDate !== void 0 ? expirationDate : getExpirationDate(accessToken),
