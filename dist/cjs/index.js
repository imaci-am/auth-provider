...
var AuthStateContext = reactExports.createContext(initialState);
var AuthDispatchContext = reactExports.createContext(undefined);
...
var AuthProvider = function (_a) {
    ...
    var _b = reactExports.useReducer(authReducer, initialState), state = _b[0], dispatch = _b[1];
    var isAuthenticated = state.isAuthenticated, user = state.user;
    var loadUser = reactExports.useCallback(function () {
        return config
            .loadUser()
            .then(function (user) {
            dispatch({
    ...
    var forceLogoutHandler = reactExports.useCallback(function () {
        var _a;
        dispatch({
            type: ActionsEnum.LOGOUT,
        });
    ...
    var dispatchContext = reactExports.useMemo(function () { return ({ dispatch: dispatch, config: config, refetchUser: loadUser }); }, [config, loadUser]);
...
function useAuthState() {
    var state = reactExports.useContext(AuthStateContext);
...
function useAuthDispatch() {
    var _this = this;
    var context = reactExports.useContext(AuthDispatchContext);
    if (typeof context === 'undefined') {
        throw new Error('useAuthDispatch must be used within a AuthProvider');
    }
    var dispatch = context.dispatch, config = context.config, refetchUser = context.refetchUser;
    var login = reactExports.useCallback(function (loginProps) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loginWithSession = reactExports.useCallback(function (accessToken, refreshToken, expirationDate) {
        saveInStorage({
            accessToken: accessToken,
            refreshToken: refreshToken,
            expirationDate: expirationDate !== null && expirationDate !== void 0 ? expirationDate : getExpirationDate(accessToken),
    ...
    var logout = reactExports.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
